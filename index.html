...
<html lang="pt-br">
  <head>
    ...
    <style>
      ...
      .principal-habilities {
        font-size: 20px;
      }
      .secondary-habilities {
        font-size: 14px;
      }
    </style>
  </head>
  ...
  <body>
    ...
    <img
      src="selfie.jpg"
      alt="Uma selfie minha com uma camisa de lã verde e fones de ouvido brancos."
      width="300px"
    />
    <p class="styled-font">
      Meu nome é José Bernardo Johann Oliveira de Souza!
    </p>
    <br /><br /><br />
    <h2 id="description">Uma breve descrição sobre mim</h2>
    <p id="styled-description" class="styled-font">
    ...
    <p>
      ...
      um cubo mágico e <em>sei</em> tocar piano.<br />Além disso, possuo
      conhecimento básico em algumas ferramentas, tais como:
      <ul>
        <li class="principal-habilities">HTML, CSS & JavaScript</li>
        <li class="principal-habilities">Node.js</li>
        <li class="secondary-habilities">Python</li>
        <li class="principal-habilities">React.js</li>
        <li class="principal-habilities">React Native</li>
        <li class="secondary-habilities">REST & RESTful APIs</li>
        <li class="secondary-habilities">UX & UI Interface</li>
        <li class="principal-habilities">ORM, SQL e NoSQL</li>
        <li class="principal-habilities">Git e GitHub</li>
      </ul>
    </p>
    <br /><br /><br />
